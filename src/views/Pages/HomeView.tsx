...
export const HomeView: React.FC<{ page: Page }> = () => {
  return (
    <div className="flex flex-col w-full overflow-hidden font-sans">
      ...
      {/* 1. Hero Section */}
      <section className="relative pt-28 pb-20 md:pt-20 md:pb-32 overflow-hidden">
        <div className="absolute top-10 left-10 w-96 h-96 bg-primary/20 rounded-full blur-[100px] -z-10 animate-pulse" />
        <div
          className="absolute top-40 right-10 w-96 h-96 bg-secondary/20 rounded-full blur-[100px] -z-10 animate-pulse"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-12 leading-relaxed max-w-3xl mx-auto font-light">
              Assistophere helps hosts and serviced accommodation businesses manage daily
              operations, guest communication, listing optimisation, and backend systems, so you can{' '}
              <strong className="text-foreground">save time, stay organised, and grow.</strong>
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-10">
              <Button
                size="lg"
                className="px-10 py-7 text-lg rounded-full shadow-xl shadow-primary/25 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 w-full sm:w-auto overflow-hidden group"
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="px-10 py-7 text-lg rounded-full border-2 hover:bg-muted font-bold w-full sm:w-auto hover:-translate-y-1 transition-all duration-300 group"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <div
                  className={`size-14 rounded-xl ${item.bg} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                >
                  {item.icon}
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold mb-6 leading-tight">
                ...
                <span className="text-primary">Constant Firefighting</span>
              </h2>
              <p className="text-xl text-muted-foreground mb-10 font-light">
                More bookings sound great until the guest messages, cleaner issues, maintenance
                problems, and admin start piling up. You end up stuck in the day-to-day instead of
                focusing on growth.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-center gap-3 p-4 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 hover:border-primary/50 transition-colors"
                  >
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-20 max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold mb-6 leading-tight">
              A More Organised, <br />
              <span className="text-primary">More Profitable</span> STR Business
            </h2>
            <p className="text-xl text-muted-foreground font-light">
              We work as your remote support team. We handle the daily operations while helping you
              build better systems for long-term growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div
                  className={`absolute top-0 right-0 w-32 h-32 ${block.bg} rounded-bl-full -mr-8 -mt-8 transition-transform group-hover:scale-110`}
                />
                <div
                  className={`size-16 rounded-2xl ${block.bg} flex items-center justify-center mb-8 relative z-10`}
                >
                  {block.icon}
                </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-xl text-slate-400 font-light">
                Choose the support you need �from day-to-day tasks to listing performance and
            ...
            <Button
              variant="outline"
              size="lg"
              className="rounded-full bg-white/5 border-white/20 text-white hover:bg-white hover:text-slate-900 group"
            >
            ...
            {[
              {
                ...
                desc: 'Fast, professional messaging before, during, and after stays.',
              },
              {
                icon: <PenTool />,
                title: 'Listing Creation & SEO',
                desc: 'Clearer, more attractive listings positioned to convert.',
              },
              {
                icon: <TrendingUp />,
                title: 'Pricing & Calendars',
                desc: 'Monitor occupancy and availability to stay strategic.',
              },
              {
                icon: <Home />,
                title: 'Check-In/Out Support',
                desc: 'Smooth arrival logistics to boost guest satisfaction.',
              },
              {
                icon: <CheckCircle2 />,
                title: 'Cleaning Coordination',
                desc: 'Manage cleaner communication and turnover follow-ups.',
              },
              {
                icon: <Wrench />,
                title: 'Maintenance Org',
                desc: 'From reporting issues to effectively managing contractors.',
              },
              {
                icon: <Globe />,
                title: 'Direct Booking Growth',
                desc: 'Website support and lead capture strategies.',
              },
              {
                icon: <Settings />,
                title: 'SOP & System Setup',
                desc: 'Structure the backend with clean workflow documentation.',
              },
              {
                icon: <Award />,
                title: 'Graphic & Brand Asset',
                desc: 'Visual content to make properties look polished online.',
              },
              {
                icon: <Users />,
                title: 'Admin & Team Sync',
                desc: 'Keep operations aligned across all working parts.',
              },
            ].map((service, idx) => (
              <div
                key={idx}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-muted-foreground">
              Four simple steps to getting your time back.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  desc: 'We look closely at your listings, current systems, and where you need help.',
                },
                {
                  step: '02',
                  title: 'Build the Plan',
                  desc: 'We design a custom support plan covering daily ops and larger business goals.',
                },
                {
                  step: '03',
                  title: 'Manage Backend',
                  desc: 'We step in to handle daily load, greatly improving operational structure.',
                },
                {
                  step: '04',
                  title: 'Focus on Growth',
                  desc: 'You step back from chaotic tasks and redirect energy into scaling up.',
                },
              ].map((item, idx) => (
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-3xl md:text-5xl font-extrabold mb-6">
                Built Around Real Host Realities
              </h2>
              <p className="text-xl text-muted-foreground mb-8">
                We understand that short-term rental support isn �t just about replying fast. It �s
                about keeping the whole business moving effectively.
              </p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-center gap-4 p-5 bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-xl border border-white dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow"
                  >
              ...
              <div className="mt-10 p-6 rounded-2xl bg-gradient-to-r from-primary to-primary/80 text-white shadow-xl shadow-primary/30">
                ...
                <p className="text-primary-foreground/80 text-lg">
                  We help carry the heavy operational load.
                </p>
              </div>
            </div>
                ...
                <div className="space-y-4 pt-8">
                  <div className="p-8 rounded-3xl bg-white dark:bg-slate-800 shadow-xl border border-slate-100 dark:border-slate-700">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Fewer missed messages, highly responsive guest relations.
                    </p>
                  </div>
                  <div className="p-8 rounded-3xl bg-white dark:bg-slate-800 shadow-xl border border-slate-100 dark:border-slate-700">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Organised cleaning, maintenance, and daily ops structure.
                    </p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="p-8 rounded-3xl bg-white dark:bg-slate-800 shadow-xl border border-slate-100 dark:border-slate-700">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Polished presentations ready to capture more bookings.
                    </p>
                  </div>
                  <div className="p-8 rounded-3xl bg-primary text-white shadow-xl shadow-primary/30 transform hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <p className="text-primary-foreground/80 font-medium">
                      Smart operational partners for your STR growth journey.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16">
            <div className="lg:col-span-4 flex flex-col justify-center">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Assistophere is a powerful fit for dedicated operators who want reliable, long-term
                support.
              </p>
            ...
            <div className="lg:col-span-8">
              <div className="p-10 rounded-[2.5rem] bg-primary text-primary-content overflow-hidden relative">
                ...
                <p className="text-primary-content/90 text-lg mb-10 max-w-2xl relative z-10">
                  We don&apos;t just help you survive the daily workload. We strengthen the backend
                  of your brand for incredible long-term growth.
                </p>
                <div className="grid sm:grid-cols-2 gap-6 relative z-10">
                  <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/10 hover:bg-white/20 transition-colors">
                    ...
                    <p className="text-primary-content/80 text-sm">
                      Website support, flow ideation, and improving user booking journeys.
                    </p>
                  </div>
                  <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/10 hover:bg-white/20 transition-colors">
                    ...
                    <p className="text-primary-content/80 text-sm">
                      SOP creation, workflow optimisations, and team support structures.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div
                    key={idx}
                    className="p-8 bg-background rounded-2xl shadow-sm border border-border relative"
                  >
                    <div className="absolute top-4 right-4 text-primary/10 font-serif text-6xl leading-none">
                      &quot;
                    </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  {
                    q: 'Do you only work with Airbnb hosts?',
                    a: 'No, we support serviced accommodation businesses and multi-platform operators.',
                  },
                  {
                    q: 'Can you support multiple listings?',
                    a: 'Yes! We specialise in operations for hosts with growing portfolios.',
                  },
                  {
                    q: 'Is this just a VA service?',
                    a: 'No. Our focus is broader: we improve daily ops, structure, and powerful business systems.',
                  },
                ].map((faq, idx) => (
                  <div
                    key={idx}
                    className="p-6 bg-background rounded-2xl shadow-sm border border-border hover:border-primary/30 transition-colors"
                  >
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-slate-300 font-light mb-12 max-w-2xl mx-auto">
            Build a setup that feels more organised, more efficient, and incredibly easy to scale.
            The right team makes all the difference.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Button
              size="lg"
              className="px-12 py-8 text-xl font-bold rounded-full w-full sm:w-auto shadow-[0_0_40px_rgba(var(--primary),0.5)] hover:shadow-[0_0_60px_rgba(var(--primary),0.7)] hover:-translate-y-1 transition-all"
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="px-12 py-8 text-xl font-bold rounded-full w-full sm:w-auto bg-transparent border-white/30 text-white hover:bg-white hover:text-slate-900 transition-all hover:-translate-y-1"
            >
              Talk to Our Team
            </Button>
          </div>
