                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    },
                    {
                      ...
                      items: ['Landlord D', 'Landlord E', 'Landlord F'],
                    },
                    {
                      col: 'Converting',
                      color: 'border-success/30 bg-success/5',
                      items: ['Deal G – Agreed', 'Deal H – Review', 'Deal I – Signed'],
                    },
                  ].map(({ col, color, items }) => (
                    <div key={col} className={`rounded-xl border p-3 ${color}`}>
                      ...
                      <div className="space-y-1.5">
                        {items.map((item) => (
                          <div
                            key={item}
                            className="text-xs bg-base-100 rounded-lg px-2 py-1.5 border border-base-300 text-base-content/70 truncate"
                          >
                            {item}
                          </div>
                        ))}
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold">
              Growth Depends on Consistent Opportunities
            </h2>
            <p className="text-base-content/65 text-lg leading-relaxed">
              Scaling a short term rental business is not just about managing properties well. It
              depends on a steady flow of new opportunities — and most hosts lack the system to
              create it.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
              {[
                {
                  icon: Search,
                  label: 'Finding new deals',
                  desc: 'Identifying the right properties and markets',
                },
                {
                  icon: Users,
                  label: 'Landlord relationships',
                  desc: 'Building trust with property owners',
                },
                {
                  icon: ClipboardList,
                  label: 'Steady pipeline',
                  desc: 'Maintaining consistent deal flow',
                },
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold">
                Why Most Hosts Struggle to Find New Properties
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                {
                  point: 'No structured outreach',
                  detail: 'Outreach happens randomly, not systematically.',
                },
                {
                  point: 'Inconsistent sourcing',
                  detail: 'Efforts are sporadic rather than ongoing.',
                },
                {
                  point: 'Relying on luck or referrals',
                  detail: 'Waiting for deals to arrive rather than generating them.',
                },
                { point: 'Lack of time', detail: 'Operations consume all available bandwidth.' },
                {
                  point: 'No follow-up system',
                  detail: 'Warm leads go cold because nothing is tracked.',
                },
              ].map(({ point, detail }) => (
                <div
                  key={point}
      ...
      <section className="bg-base-200 border-y border-base-300 py-20 lg:py-28">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold">
              What a Proper Lead Generation System Should Do
            </h2>
          </div>
            ...
            {[
              {
                ...
                desc: 'Finding suitable properties and landlords in target locations.',
              },
              {
                icon: MessageSquare,
                title: 'Reach Out Consistently',
                desc: 'Maintaining regular contact with potential leads without gaps.',
              },
              {
                icon: ClipboardList,
                title: 'Track and Manage Leads',
                desc: 'Keeping everything organised, followed up, and visible.',
              },
              {
                icon: CheckCircle2,
                title: 'Convert Leads into Deals',
                desc: 'Turning interest and engagement into actual properties.',
              },
            ...
            {[
              {
                ...
                outcome: 'A curated list of high-potential properties to pursue.',
              },
              {
                area: 'Landlord Outreach',
                icon: Users,
                tasks: [
                ...
                outcome: 'Warm landlord contacts ready for deeper conversation.',
              },
              {
                area: 'Lead Tracking',
                icon: ClipboardList,
                tasks: [
                  'Organising all leads',
                  'Managing communication records',
                  'Tracking progress per lead',
                ],
                outcome: 'Full visibility over every opportunity at every stage.',
              },
              {
                ...
                outcome: 'Fewer cold leads, higher conversion rate over time.',
              },
              {
                ...
                tasks: [
                  ...
                  'Maintaining deal visibility',
                  'Reporting on progress',
                ],
                outcome: 'A structured, predictable pipeline of new opportunities.',
              },
      ...
      <section className="bg-base-200 border-y border-base-300 py-20 lg:py-28">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-base-content/65 text-lg leading-relaxed">
              Lead generation connects directly to your operations, your revenue, and your expansion
              plans. Without a consistent pipeline, scaling becomes difficult regardless of how well
              ...
              {[
                {
                  icon: Zap,
                  label: 'Operations',
                  desc: 'More properties mean more capacity to fill and optimise.',
                },
                {
                  icon: BarChart3,
                  label: 'Revenue',
                  desc: 'A growing portfolio directly increases earning potential.',
                },
                {
                  icon: TrendingUp,
                  label: 'Expansion',
                  desc: 'Consistent deal flow makes scaling a repeatable process.',
                },
              ].map(({ icon: Icon, label, desc }) => (
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-3">
              {[
                {
                  mistake: 'Inconsistent outreach',
                  why: 'Gaps in outreach mean leads go cold and opportunities are missed.',
                },
                {
                  mistake: 'No tracking system',
                  why: 'Without visibility, leads are forgotten and progress is lost.',
                },
                {
                  mistake: 'No follow-up',
                  why: 'Most deals require multiple touchpoints — one attempt is not enough.',
                },
                {
                  mistake: 'Targeting the wrong properties',
                  why: 'Poor qualification wastes time on unsuitable landlords or locations.',
                },
                {
                  mistake: 'Lack of structure',
                  why: 'Ad-hoc efforts produce ad-hoc results. Systems produce consistency.',
                },
              ].map(({ mistake, why }) => (
                <div
                  key={mistake}
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                {
                  point: 'Structured outreach',
                  detail: 'Every campaign follows a defined process, not guesswork.',
                },
                {
                  point: 'Maintained consistency',
                  detail: 'Outreach continues on schedule regardless of operational noise.',
                },
                {
                  point: 'Every lead tracked',
                  detail: 'Nothing falls through the cracks — all leads are recorded and visible.',
                },
                {
                  point: 'Focused on conversion',
                  detail: 'We do not just generate leads; we move them toward deals.',
                },
              ].map(({ point, detail }) => (
                <div
                  key={point}
      ...
      <section className="py-20 lg:py-28">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold">
              Unstructured Sourcing vs Structured Lead Generation
            </h2>
          </div>
        ...
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {[
              {
                icon: TrendingUp,
                who: 'Hosts looking to expand',
                desc: 'Ready to grow but lacking a system to find new properties.',
              },
              {
                icon: Building2,
                who: 'SA businesses',
                desc: 'Serviced accommodation operators who need a pipeline.',
              },
              {
                icon: BarChart3,
                who: 'Portfolio operators',
                desc: 'Scaling portfolios that need consistent deal flow.',
              },
              {
                icon: Target,
                who: 'Growth-focused hosts',
                desc: 'Hosts who want consistent, repeatable opportunities.',
              },
            ...
            {[
              {
                ...
                quote:
                  'Within two months we had a pipeline of leads we never would have found ourselves. The structure made all the difference.',
              },
              {
                initials: 'JM',
                name: 'James M.',
                ...
                quote:
                  'Before Assistophere, sourcing was completely ad hoc. Now we have a proper system and actual deals coming through.',
              },
              {
                initials: 'PR',
                name: 'Priya R.',
                role: 'Portfolio Host · Bristol',
                quote:
                  'The follow-up process alone was worth it. Leads that would have gone cold are now converting.',
              },
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-3">
              <FaqItem
                ...
                a="We focus on properties suitable for short term rental and serviced accommodation in the UK. This includes residential properties in high-demand locations where STR or SA models can generate strong returns."
              />
              <FaqItem
                q="How do you find leads?"
                a="We use a combination of targeted outreach, digital research, and structured prospecting to identify landlords and property owners open to STR or SA arrangements. Every lead is qualified before it enters your pipeline."
              />
              <FaqItem
                q="Do you handle landlord outreach directly?"
                a="Yes. We manage the initial contact, introductions, and early relationship-building so you can focus on converting and managing properties rather than cold outreach."
              />
              <FaqItem
                q="Can this help scale my business?"
                a="Lead generation is specifically designed to support growth. By creating a consistent pipeline of new opportunities, it removes one of the biggest blockers to scaling — the lack of deals coming through reliably."
              />
            </div>
          </div>
        </div>
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-primary/22 via-base-200 to-secondary/15 border border-base-300 px-8 py-16 lg:px-16 text-center shadow-xl">
            ...
            <div className="max-w-2xl mx-auto space-y-6">
              ...
              <p className="text-base-content/65 text-lg leading-relaxed">
                Let&apos;s create a lead generation system that supports your growth. We don&apos;t
                just find opportunities — we build a system that brings them consistently.
              </p>
