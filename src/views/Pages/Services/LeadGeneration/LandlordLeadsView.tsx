...
const whoItIsFor = [
  {
    ...
    label: 'Co-hosts and property managers looking to grow their portfolio of managed properties',
  },
  {
    icon: <TrendingUp className="w-5 h-5 text-primary" />,
    label: 'STR operators wanting a scalable, consistent flow of new landlord clients',
  },
  {
    icon: <Users className="w-5 h-5 text-primary" />,
    label: 'Airbnb management companies that need a structured acquisition pipeline',
  },
  {
    icon: <Target className="w-5 h-5 text-primary" />,
    label: 'Anyone tired of relying on referrals and wanting predictable growth',
  },
]

export const LandlordLeadsView: React.FC<{ page: Page }> = ({ page: _page }) => {
  return (
    <>
      <style>{`
        @keyframes llFadeUp {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="ll-fade-3 text-lg text-base-content/70 leading-relaxed mb-5 max-w-lg">
                Targeted lead generation for STR operators, co-hosts, and property management
                companies — so you always have a pipeline of qualified landlords ready to onboard.
              </p>
              ...
              <div className="ll-fade-3 p-4 rounded-xl border border-primary/20 bg-primary/6 text-sm italic text-base-content/60 mb-8 max-w-lg">
                &ldquo;Landlord lead generation gives property management businesses a structured,
                scalable way to grow their portfolio — without relying on word of mouth or cold
                outreach.&rdquo;
              </div>
                ...
                <div className="px-4 pb-4 pt-3">
                  <div className="p-3 rounded-xl bg-primary/8 border border-primary/20">
                    ...
                    <p className="text-xs text-base-content/70">
                      3 leads ready for follow-up call. Thomas H. responded to outreach — property
                      in prime Airbnb location, 2-bed apartment.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="bg-base-200 border-y border-base-300 py-20 lg:py-28">
        <div className="container max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-base-content/65 leading-relaxed max-w-2xl mx-auto mb-8">
            Most STR operators grow their portfolio through referrals and chance. That works — until
            it doesn&apos;t. When you need predictable growth, you need a system that consistently
            puts you in front of the right landlords, in your target area, before your competitors
            do.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
            {[
              {
                icon: <Target className="w-5 h-5 text-primary" />,
                title: 'Qualified, Not Random',
                body: 'Every lead is filtered for location, property type, and intent — so you spend time on conversations that have real potential.',
              },
              {
                icon: <TrendingUp className="w-5 h-5 text-secondary" />,
                title: 'Consistent Volume',
                body: 'A structured lead gen system keeps your pipeline filled — not spiking after referrals and empty the month after.',
              },
              {
                icon: <Layers className="w-5 h-5 text-accent" />,
                title: 'Scalable as You Grow',
                body: 'The system scales with your business — more volume, wider geography, and improved targeting as your portfolio grows.',
              },
            ].map((item, i) => (
        ...
        <div className="container max-w-5xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-base-content/65 max-w-xl mx-auto">
              Without a structured approach to finding landlords, growth stays slow, unpredictable,
      ...
      <section className="bg-base-200 border-y border-base-300 py-20 lg:py-28">
        <div className="container max-w-5xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-base-content/65 max-w-xl mx-auto">
              A well-built landlord lead generation system runs consistently — qualified prospects
              flowing in while you focus on managing properties.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: 'Regular Lead Delivery',
                body: 'New qualified landlord prospects are delivered on a regular cadence — not in batches when you remember to ask.',
              },
              {
                icon: <Target className="w-5 h-5 text-success" />,
                title: 'Pre-Qualified Before You See Them',
                body: 'Leads are screened against your criteria — property type, location, readiness — before they ever reach your pipeline.',
              },
              {
                icon: <Phone className="w-5 h-5 text-success" />,
                title: 'Warm When You Call',
                body: "Your first conversation with a landlord isn't cold — they've already expressed interest and know what you offer.",
              },
              {
                icon: <TrendingUp className="w-5 h-5 text-success" />,
                title: 'Data-Backed Optimisation',
                body: 'Every lead source and message is tracked so the system improves over time — more volume, better conversion.',
              },
            ].map((item, i) => (
              <div
                key={i}
      ...
      <section className="py-20 lg:py-28">
        <div className="container max-w-5xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-base-content/65 max-w-xl mx-auto">
              From finding the right prospects to getting them into your pipeline warm, here&apos;s
      ...
      <section className="bg-base-200 border-y border-base-300 py-20 lg:py-28">
        <div className="container max-w-5xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-base-content/65 max-w-xl mx-auto">
              Our landlord lead generation approach is built around finding the right property
              owners and getting them to the right conversation — efficiently.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <section className="py-20 lg:py-28">
        <div className="container max-w-5xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-base-content/65 max-w-xl mx-auto">
              The difference between hoping landlords find you and having a system that finds them
              first.
            </p>
          </div>
          ...
          <div className="hidden md:block rounded-2xl border border-base-300 overflow-hidden">
            <div className="grid grid-cols-3 bg-base-200 border-b border-base-300 px-6 py-3 text-xs font-semibold uppercase tracking-widest text-base-content/50">
              ...
              <span className="flex items-center gap-1.5">
                <XCircle className="w-3.5 h-3.5 text-error" /> Without Lead Gen
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="w-3.5 h-3.5 text-success" /> With Our System
              </span>
            </div>
      ...
      <section className="bg-base-200 border-y border-base-300 py-20 lg:py-28">
        <div className="container max-w-4xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-base-content/65 max-w-xl mx-auto">
              Landlord lead generation is most valuable for operators who want a structured,
              predictable way to grow their managed portfolio.
            </p>
          </div>
        ...
        <div className="container max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                quote:
                  'Before working with Assistophere I was entirely reliant on referrals for new landlords. Within three months of having a proper lead gen system we onboarded four new properties — all from the pipeline they built.',
                name: 'Marcus D.',
                role: 'Property management company, Manchester',
              },
              {
                quote:
                  "The quality of leads was what surprised me most. I expected a list of names — instead I got pre-qualified prospects who had already expressed interest in STR management. The conversion rate was significantly better than anything I'd done in-house.",
                name: 'Sophie W.',
                role: 'Co-host, London',
              },
              {
                quote:
                  'We were spending hours a week doing cold outreach with almost nothing to show for it. Having a professional lead generation system running in the background has completely changed how we grow our portfolio.',
                name: 'James T.',
                role: 'Multi-property STR operator, Birmingham',
              },
            ].map((t, i) => (
              <div
                key={i}
        ...
        <div className="container max-w-4xl mx-auto px-4">
          <div className="relative overflow-hidden rounded-3xl p-10 lg:p-14 text-center bg-linear-to-br from-primary/22 via-base-200 to-secondary/15 border border-base-300">
            ...
            <p className="text-base-content/65 max-w-xl mx-auto mb-8">
              Stop waiting for referrals. Get a structured landlord lead generation system that
              consistently brings qualified property owners to your door.
            </p>
