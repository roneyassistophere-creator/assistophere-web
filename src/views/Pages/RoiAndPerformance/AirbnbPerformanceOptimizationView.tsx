...
import {
  TrendingUp, Settings, Star, Phone, ArrowRight, CheckCircle2, XCircle,
  BarChart3, Target, Building2, MessageSquare, ChevronRight,
  AlertTriangle, CalendarDays, Megaphone, Zap, LineChart,
  Activity, LayoutDashboard, Search,
} from 'lucide-react'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6">
              ...
              <div className="apo-fade-4 p-4 rounded-xl border border-primary/20 bg-primary/6 text-sm italic text-base-content/65">
                Airbnb performance optimisation involves improving listings, pricing, and
                operations to increase bookings, occupancy, and overall revenue.
              </div>
            ...
            <div className="hidden lg:block">
              <div className="relative rounded-3xl border border-base-300 bg-base-200/60 backdrop-blur-sm p-7 shadow-xl">
                <div className="flex items-center gap-2 mb-5">
                  ...
                  <span className="ml-2 text-xs text-base-content/40 font-mono">performance.dashboard</span>
                </div>
                <div className="grid grid-cols-2 gap-3 mb-4">
                  {[
                    ...
                    <div key={label} className="bg-base-100 rounded-xl border border-base-300 px-4 py-3">
      ...
      <section className="bg-base-200 border-y border-base-300 py-20 lg:py-28">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold">Performance Isn&apos;t One Thing. It&apos;s Everything Working Together.</h2>
            <p className="text-base-content/65 text-lg leading-relaxed">
              Most hosts focus on a single lever — usually the listing or the price.
              But performance is the result of multiple factors running in sync.
              Improving just one part won&apos;t fix the whole system.
            </p>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
              {[
                ...
                <div key={label} className="bg-base-100 rounded-2xl border border-primary/15 p-4 text-center">
            ...
            <p className="text-base-content/55 text-sm italic">All four need to work together for performance to improve meaningfully.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { point: 'Poor listing presentation', detail: 'Weak photography, incomplete descriptions, and missing amenity details suppress search visibility and reduce booking conversion rate.' },
                { point: 'Incorrect pricing', detail: 'Flat pricing or rates set without reference to local demand leave revenue uncaptured during peak periods and reduce occupancy in slow ones.' },
                { point: 'Calendar gaps', detail: 'Minimum stay restrictions, blocked dates, and poor availability windows create unnecessary gaps that reduce total occupancy.' },
                { point: 'Slow guest communication', detail: 'Response time is a direct ranking signal on Airbnb. Slow replies reduce visibility and lose bookings to faster-responding competitors.' },
                { point: 'Weak operational structure', detail: 'Inconsistent cleaning standards, late check-ins, and poor guest experience directly impact review scores — the primary driver of long-term performance.' },
              ].map(({ point, detail }) => (
      ...
      <section className="bg-base-200 border-y border-base-300 py-20 lg:py-28">
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 max-w-6xl mx-auto">
            {[
              { icon: Megaphone, title: 'Listing Optimisation', desc: 'Photography, description, titles, amenity listings, and highlight sections — all reviewed and improved for visibility and conversion.' },
              { icon: BarChart3, title: 'Pricing Strategy', desc: 'Dynamic pricing calibrated to local demand, seasonality, and competitor positioning — not guesswork or a flat rate.' },
              { icon: CalendarDays, title: 'Calendar Management', desc: 'Minimum stay rules, availability windows, and gap-filling strategies that reduce dead dates without lowering standards.' },
              { icon: MessageSquare, title: 'Guest Communication', desc: 'Faster response times, automated sequences, and guest experience improvements that build stronger review scores.' },
              { icon: Settings, title: 'Operational Efficiency', desc: 'Cleaning, turnover, maintenance, and check-in processes reviewed and improved to protect review scores and reduce cost per stay.' },
      ...
      <section className="py-20 lg:py-28">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold">What Our Performance Optimisation Covers</h2>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr_1.5fr] gap-px bg-base-300 rounded-3xl overflow-hidden border border-base-300">
            ...
            <div className="bg-base-200 px-5 py-3 text-xs font-bold uppercase tracking-widest text-base-content/40">What We Improve</div>
            <div className="bg-base-200 px-5 py-3 text-xs font-bold uppercase tracking-widest text-base-content/40">Outcome</div>
            {[
              {
                area: 'Listing Performance', icon: Megaphone,
                tasks: ['Improving search visibility through better content and keywords', 'Refining photography, titles, and description structure', 'Increasing engagement and booking conversion rate'],
                outcome: 'Your listing appears more often and converts more of its traffic into bookings.',
              },
              {
                area: 'Pricing & Revenue', icon: BarChart3,
                tasks: ['Adjusting nightly pricing to reflect real demand patterns', 'Improving occupancy without sacrificing revenue per stay', 'Maximising returns across peak, shoulder, and low seasons'],
                outcome: 'More revenue per available night, with fewer calendar gaps.',
              },
              {
                area: 'Calendar Efficiency', icon: CalendarDays,
                tasks: ['Reducing unnecessary empty dates through availability optimisation', 'Improving booking flow with smarter minimum-stay rules', 'Filling shoulder periods without undermining rate strategy'],
                outcome: 'Higher occupancy with fewer wasted dates across the calendar.',
              },
              {
                area: 'Guest Experience', icon: MessageSquare,
                tasks: ['Improving communication speed and consistency', 'Reducing friction in the check-in and check-out process', 'Enhancing the overall guest experience to drive better reviews'],
                outcome: 'Stronger review scores that directly increase future booking performance.',
              },
              {
                area: 'System Alignment', icon: Zap,
                tasks: ['Connecting pricing, calendar, listing, and operations into a coherent system', 'Ensuring each part of the business supports overall performance', 'Identifying and closing gaps between the different operational layers'],
                outcome: 'A balanced, coordinated operation where every element reinforces the others.',
              },
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold">What Changes When Performance Improves</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-error/20 bg-error/4 p-6">
                <p className="text-xs font-bold uppercase tracking-widest text-error/60 mb-4">Before Optimisation</p>
              ...
              <div className="rounded-2xl border border-success/20 bg-success/5 p-6">
                <p className="text-xs font-bold uppercase tracking-widest text-success/60 mb-4">After Optimisation</p>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={point} className="flex gap-3 items-start">
                      ...
                      <p className="text-sm text-base-content/70 font-medium leading-relaxed">{point}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section className="py-20 lg:py-28">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-3">
              {[
                { mistake: 'Focusing on one area only', why: 'Updating just the listing or just the price without addressing the other factors produces marginal or temporary gains at best.' },
                { mistake: 'Ignoring data', why: 'Occupancy trends, competitor pricing, and review patterns contain specific signals about where performance is being lost — most hosts never read them.' },
                { mistake: 'No consistent monitoring', why: 'Performance changes over time with seasons, market conditions, and algorithm updates. One-off changes are not enough.' },
                { mistake: 'Copying competitors', why: "Matching a competitor's pricing or listing structure without understanding the underlying context rarely translates to equivalent results." },
                { mistake: 'No structured approach', why: 'Ad hoc changes without a clear framework make it impossible to know what worked, what did not, and what to try next.' },
              ].map(({ mistake, why }) => (
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold">How We Optimise Performance Properly</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { step: '1. Analyse the full setup', detail: 'We review listing content, pricing configuration, calendar structure, operational workflows, and review scores — the complete picture.' },
                { step: '2. Identify key gaps', detail: 'We pinpoint the specific areas where performance is being lost and prioritise them by impact — not everything is equally important.' },
                { step: '3. Apply structured improvements', detail: 'Changes are implemented methodically across every relevant area, with clear reasoning behind each decision.' },
                { step: '4. Monitor and refine', detail: 'We track the impact of changes over time and continue refining based on what the data shows — because optimisation is ongoing, not a single event.' },
              ].map(({ step, detail }) => (
        ...
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <div className="hidden md:block overflow-hidden rounded-3xl border border-base-300 max-w-3xl mx-auto">
            <div className="grid grid-cols-3">
              ...
              <div className="bg-error/8 px-5 py-3 text-xs font-bold uppercase tracking-widest text-error/70 text-center">Unoptimised</div>
              <div className="bg-success/8 px-5 py-3 text-xs font-bold uppercase tracking-widest text-success/70 text-center">Optimised</div>
            </div>
            {[
      ...
      <section className="bg-base-200 border-y border-base-300 py-20 lg:py-28">
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {[
              { icon: Search, who: 'Underperforming listings', desc: 'Properties with occupancy or revenue below what the market should support.' },
              { icon: Building2, who: 'SA businesses', desc: 'Serviced accommodation operators with multiple units needing systematic performance improvement.' },
              { icon: TrendingUp, who: 'Scaling portfolios', desc: 'Operators growing their portfolio who need consistent performance before adding more properties.' },
              { icon: Activity, who: 'Hosts wanting better results', desc: 'Any host who knows their current performance is not where it should be and wants a structured path to improvement.' },
      ...
      <section className="py-20 lg:py-28">
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              { initials: 'GH', name: 'George H.', role: 'Multi-property Host · London', quote: 'My occupancy had been stuck at around 60% for months. After the full optimisation — listing, pricing, and calendar — it moved to 76% within six weeks. The difference was measurable almost immediately.' },
              { initials: 'FW', name: 'Fiona W.', role: 'SA Operator · Leeds', quote: 'I had no idea my minimum stay settings were costing me that many bookings. One change to the calendar structure combined with new pricing rules improved my monthly revenue noticeably.' },
              { initials: 'KS', name: 'Kofi S.', role: 'STR Host · Birmingham', quote: "My review score had dropped and I wasn't sure why. The operational review identified the exact problem. After fixing the check-in process and communication flow, my score recovered within two months." },
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-primary/22 via-base-200 to-secondary/15 border border-base-300 px-8 py-16 lg:px-16 text-center shadow-xl">
            ...
            <div className="max-w-2xl mx-auto space-y-6">
              ...
              <p className="text-base-content/65 text-lg leading-relaxed">
                Let&apos;s optimise your setup and improve your results.
                We don&apos;t just improve listings — we improve your entire performance.
              </p>
              ...
              <p className="text-xs text-base-content/40 pt-2">
                Airbnb Performance Optimisation UK · Improve Airbnb Bookings · STR Performance Improvement · Airbnb Growth Strategy
              </p>
            </div>
          </div>
        </div>
