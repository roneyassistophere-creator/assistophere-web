...
export const AirbnbPerformanceOptimizationView: React.FC<{ page: Page }> = ({ page }) => {
  return (
    <div className="container mx-auto py-12">
      <h1 className="text-4xl font-bold mb-8">{page.title || 'Airbnb Performance Optimization'}</h1>
      {page.content ? (
