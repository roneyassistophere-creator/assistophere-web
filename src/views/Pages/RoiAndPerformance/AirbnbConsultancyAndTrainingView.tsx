          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6">
              ...
              <p className="act-fade-3 text-lg text-base-content/70 leading-relaxed max-w-lg">
                Assistophere provides expert guidance and training for UK hosts, helping you improve
                operations, performance, and long-term growth through structured advice.
              </p>
            ...
            <div className="hidden lg:block">
              <div className="relative rounded-3xl border border-base-300 bg-base-200/60 backdrop-blur-sm p-7 shadow-xl">
                ...
                <div className="space-y-3">
                  {[
                    {
                      area: 'Listing & Pricing Audit',
                      finding: 'Flat rate — losing 22% revenue in peak weeks',
                      fix: 'Dynamic pricing implemented',
                      status: 'resolved',
                    },
                    {
                      area: 'Operations Review',
                      finding: 'Manual guest comms — 3hr/day average',
                      fix: 'Automated message sequences',
                      status: 'resolved',
                    },
                    {
                      area: 'Team Structure',
                      finding: 'No defined roles — host doing everything',
                      fix: 'VA roles scoped and assigned',
                      status: 'resolved',
                    },
                    {
                      area: 'Scaling Plan',
                      finding: 'No roadmap for property 2',
                      fix: 'Portfolio strategy drafted',
                      status: 'active',
                    },
                  ].map(({ area, finding, fix, status }) => (
                    <div
                      key={area}
                      className={`rounded-xl border px-4 py-3 ${status === 'resolved' ? 'border-success/20 bg-success/5' : 'border-primary/20 bg-primary/6'}`}
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <span
                          className={`text-[10px] font-bold px-2 py-0.5 rounded-full shrink-0 mt-0.5 ${status === 'resolved' ? 'bg-success/15 text-success' : 'bg-primary/15 text-primary'}`}
                        >
                ...
                <p className="text-center text-xs text-base-content/35 mt-4">
                  Real issues · Clear fixes · Structured progress
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-base-content/65 text-lg leading-relaxed">
              Some hosts want guidance, clarity, and direction — not full outsourcing. They want to
              stay in control but operate with better strategy and more confidence. That&apos;s
              exactly where consultancy and training come in.
            </p>
              ...
              {[
                {
                  icon: Compass,
                  label: 'Guidance',
                  desc: 'Expert direction on the right approach for your specific situation and goals.',
                },
                {
                  icon: Lightbulb,
                  label: 'Clarity',
                  desc: 'Clear understanding of what is working, what is not, and what to do next.',
                },
                {
                  icon: Target,
                  label: 'Direction',
                  desc: 'A structured plan that moves your business forward without guesswork.',
                },
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold">
                Why Hosts Struggle Without Guidance
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                {
                  point: 'Unclear strategy',
                  detail:
                    'Operating without a clear plan means reacting to problems rather than preventing them — and progress is unpredictable.',
                },
                {
                  point: 'Inconsistent decisions',
                  detail:
                    'Without a framework, decisions change based on what feels right in the moment rather than what the data and strategy suggest.',
                },
                {
                  point: 'Lack of structure',
                  detail:
                    'Operations that have never been properly structured become increasingly chaotic as the business grows.',
                },
                {
                  point: 'No expert input',
                  detail:
                    'Hosts without access to experienced guidance spend months solving problems that an expert could resolve in a single session.',
                },
                {
                  point: 'Trial and error',
                  detail:
                    'Learning through mistakes in a live business is expensive — in time, money, and missed opportunity.',
                },
              ].map(({ point, detail }) => (
                <div
                  key={point}
      ...
      <section className="bg-base-200 border-y border-base-300 py-20 lg:py-28">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold">
              What You Get From Proper STR Consultancy
            </h2>
          </div>
            ...
            {[
              {
                ...
                desc: 'Understanding exactly what to do next in your business — and why — rather than guessing which step to take.',
              },
              {
                icon: Zap,
                title: 'Problem Solving',
                desc: 'Identifying root causes of underperformance quickly and resolving them with targeted, practical fixes.',
              },
              {
                icon: Target,
                title: 'Strategic Thinking',
                desc: 'Making better long-term decisions by thinking beyond the immediate issue and building toward a clear goal.',
              },
              {
                icon: TrendingUp,
                title: 'Structured Improvement',
                desc: 'A methodical approach to improving systems and performance that compounds over time rather than producing one-off gains.',
              },
      ...
      <section className="py-20 lg:py-28">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold">
              What Our Consultancy &amp; Training Includes
            </h2>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr_1.5fr] gap-px bg-base-300 rounded-3xl overflow-hidden border border-base-300">
            ...
            {[
              {
                area: 'Listing & Performance Review',
                icon: BarChart3,
                tasks: [
                  'Auditing current listings across platforms',
                  'Identifying specific improvements to content, structure, and conversion',
                  'Refining setup to improve visibility and booking rate',
                ],
                outcome:
                  'You know exactly why your listing is or is not performing — and what to change.',
              },
              {
                area: 'Pricing & Calendar Guidance',
                icon: TrendingUp,
                tasks: [
                  'Reviewing current pricing strategy against market data',
                  'Advising on dynamic pricing setup and seasonal adjustments',
                  'Improving availability management to increase occupancy',
                ],
                outcome:
                  'A pricing approach that captures more revenue without sacrificing occupancy.',
              },
              {
                area: 'Operations Advice',
                icon: Settings,
                tasks: [
                  'Reviewing current operational workflows for inefficiencies',
                  'Advising on process structure and guest-handling procedures',
                  'Identifying where time and money are being lost unnecessarily',
                ],
                outcome:
                  'Streamlined operations that take less effort and deliver more consistent results.',
              },
              {
                area: 'Systems & Automation Guidance',
                icon: Zap,
                tasks: [
                  'Identifying gaps in current automation setup',
                  'Advising on which tools and integrations make sense for your operation',
                  'Recommending improvements that save time and reduce manual work',
                ],
                outcome: 'A clearer, better-configured system that does more of the work for you.',
              },
              {
                area: 'Team & Scaling Support',
                icon: Users,
                tasks: [
                  'Advising on team structure and role definition',
                  'Improving coordination and accountability within existing teams',
                  'Planning the structure needed to support portfolio growth',
                ],
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-base-content/60 mt-4 text-sm leading-relaxed max-w-xl mx-auto">
                Consultancy gives you direction. Training gives your operation the ability to
                execute it correctly without relying on external guidance every time.
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                {
                  icon: UserCheck,
                  label: 'Host-level training',
                  desc: 'You understand your business more deeply — the metrics that matter, the decisions that move the needle, and the systems that support it.',
                },
                {
                  icon: Users,
                  label: 'Team-level training',
                  desc: 'Your team can operate effectively without constant oversight. Each person understands their role and the process behind it.',
                },
                {
                  icon: ClipboardList,
                  label: 'Process training',
                  desc: 'Procedures are followed correctly and consistently — reducing errors, improving guest experience, and increasing operational reliability.',
                },
              ].map(({ icon: Icon, label, desc }) => (
                <div
                  key={label}
                  className="bg-base-100 rounded-2xl border border-secondary/15 p-5 text-center"
                >
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold">
                Where Hosts Go Wrong Without Guidance
              </h2>
            </div>
            <div className="space-y-3">
              {[
                {
                  mistake: 'Guessing strategies',
                  why: 'Making pricing, listing, and operational decisions based on intuition rather than data leads to inconsistent and often poor results.',
                },
                {
                  mistake: 'Copying others',
                  why: "Applying another host's approach to a different property, market, or guest type rarely works — context determines what the right strategy is.",
                },
                {
                  mistake: 'Inconsistent decisions',
                  why: 'Changing approach frequently without a clear framework prevents any strategy from gaining traction and makes performance hard to improve.',
                },
                {
                  mistake: 'Ignoring data',
                  why: 'Occupancy rates, review scores, response times, and booking lead times all contain actionable signals — most hosts never look at them properly.',
                },
                {
                  mistake: 'No structured approach',
                  why: 'Without a consistent method for reviewing and improving performance, the same problems recur and progress stalls.',
                },
              ].map(({ mistake, why }) => (
                <div
                  key={mistake}
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold">
                How We Deliver Consultancy Properly
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                {
                  ...
                  detail:
                    'We review your listings, pricing, operations, and systems to build an accurate picture of where your business currently stands.',
                },
                {
                  step: '2. Identify key issues',
                  detail:
                    'We pinpoint the specific areas that are limiting your performance — not general feedback, but targeted findings with evidence.',
                },
                {
                  step: '3. Provide clear recommendations',
                  detail:
                    'We give you a prioritised, actionable set of improvements with clear reasoning behind each one.',
                },
                {
                  step: '4. Focus on practical improvements',
                  detail:
                    'Our recommendations are designed to be implemented — not theoretical concepts but concrete actions that move your numbers.',
                },
              ].map(({ step, detail }) => (
                <div
                  key={step}
        ...
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {[
              {
                icon: UserCheck,
                who: 'Self-managing hosts',
                desc: 'Hosts running their own operation who want expert input without handing over control.',
              },
              {
                icon: Building2,
                who: 'SA businesses',
                desc: 'Serviced accommodation operators who need strategic guidance to improve performance at scale.',
              },
              {
                icon: GraduationCap,
                who: 'Teams needing training',
                desc: 'Operations with staff or VAs who need structured training to work more effectively.',
              },
              {
                icon: Compass,
                who: 'Operators wanting clarity',
                desc: 'Businesses that have grown and need a clear strategy to manage complexity and plan the next stage.',
              },
            ...
            {[
              {
                ...
                quote:
                  "I didn't want someone else to run my business — I wanted to run it better myself. The consultancy session identified three changes I made immediately. My occupancy improved in the following month.",
              },
              {
                initials: 'TN',
                name: 'Thomas N.',
                ...
                quote:
                  'We had five properties and no clear strategy. The review showed us exactly what was wrong with our pricing and operations. The training session brought my team up to speed properly.',
              },
              {
                initials: 'PB',
                name: 'Priya B.',
                ...
                quote:
                  'I was making decisions based on what others were doing in Facebook groups. The consultancy gave me a framework to make proper decisions based on my own data. The difference is significant.',
              },
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-primary/22 via-base-200 to-secondary/15 border border-base-300 px-8 py-16 lg:px-16 text-center shadow-xl">
            ...
            <div className="max-w-2xl mx-auto space-y-6">
              ...
              <p className="text-base-content/65 text-lg leading-relaxed">
                Let&apos;s review your setup and give you a clear plan to move forward. We
                don&apos;t just give advice — we give direction that works.
              </p>
              ...
              <p className="text-xs text-base-content/40 pt-2">
                Airbnb Consultancy UK · STR Consulting Services · Airbnb Training UK · Serviced
