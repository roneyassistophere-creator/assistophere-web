  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Pricing Optimisation', value: 'pricing-optimisation' },
        { label: 'Professional Photography', value: 'professional-photography' },
        { label: 'Guest Communication', value: 'guest-communication' },
        { label: 'Guest Vetting', value: 'guest-vetting' },
        { label: 'Guest Check-In & Check-Out', value: 'guest-check-in-check-out' },
        { label: 'Calendar Management', value: 'calendar-management' },
        { label: 'Cleaning Coordination', value: 'cleaning-coordination' },
        { label: 'Linen & Toiletries Management', value: 'linen-toiletries' },
        { label: 'Property Maintenance', value: 'property-maintenance' },
        { label: 'Monthly Finance Reporting', value: 'monthly-finance-reporting' },
        { label: 'Graphical Content Creation', value: 'graphical-content-creation' },
        { label: 'Direct Booking Engine', value: 'direct-booking-engine' },
        { label: 'Direct Booking Website', value: 'direct-booking-website' },
        { label: 'Direct Booking Conversions', value: 'direct-booking-conversions' },
        ...
        { label: 'Landlord Leads', value: 'landlord-leads' },
        { label: 'Guest Leads', value: 'guest-leads' },
        ...
        { label: 'Posting & Scheduling', value: 'posting-and-scheduling' },
        { label: 'Brand Growth', value: 'brand-growth' },
